...
const List<MimoAdvancedExample> mimoAdvancedExamples = <MimoAdvancedExample>[
  MimoAdvancedExample(
    title: '沧桑老前辈叙事',
    scenario: '官方 Case1：用低沉沙哑、娓娓道来的方式讲普通人的坚韧故事。',
    ...
    notes: '自然语言 Instruct 放在 role:user；正文只保留实际要合成的内容。官方示例使用冰糖音色。',
    voiceName: '冰糖',
  ...
  MimoAdvancedExample(
    title: '灭世神祇导演模式',
    scenario: '官方 Case2：用 CHARACTER / SCENE / DIRECTION 组织影视级角色表演。',
    stylePrompt:
    ...
    notes: '适合角色配音、游戏 NPC 和影视旁白。官方示例使用白桦音色。',
    voiceName: '白桦',
  ...
  MimoAdvancedExample(
    title: '星际航线标签编排',
    scenario: '官方“灵活的音频标签控制能力”：在同一段文本里混合多种情绪、状态和节奏。',
    stylePrompt: '',
    text:
  ...
  MimoAdvancedExample(
    title: '发射倒计时文本理解',
    scenario: '官方“丰富的文本理解能力”：没有 prompt 和标签，只靠标点、大小写和节奏表达情绪。',
    stylePrompt: '',
    text:
  ...
  MimoAdvancedExample(
    title: '纪录片旁白音色设计',
    scenario: '官方 Voice Design Case1：用自然语言生成“纪录片旁白解说员”音色。',
  ...
  MimoAdvancedExample(
    title: '北方老先生音色设计',
    scenario: '官方 Voice Design Case2：年龄、口音、语速、质感、角色感共同塑造音色。',
    stylePrompt:
