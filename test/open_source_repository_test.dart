...
void main() {
  ...
  test(
    'open source repository keeps release-only surfaces out of source',
    skip: _hasProductBranchConfigSupport
        ? 'Product branch intentionally keeps JSON-driven release surfaces.'
        : false,
    () {
...
bool get _hasProductBranchConfigSupport {
  return File('lib/src/app/product_build_config.dart').existsSync();
}
